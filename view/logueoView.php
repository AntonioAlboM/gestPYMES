...
<div class="container inicio">
    <div class="row justify-content-center">
        <div class="col col-md-12">
            <div>
                <h1 class="tituloInicio  text-center title">Bienvenido a su empresa <?php echo $_SESSION['gerente']; ?></h1>
        ...
        <div class="container">
            ...
            <div class="card text-white bg-secondary my-4 text-center">
                <div class="card-body">
                    <h2 class="text-white m-0 title">Inicio Rápido</h2>
                </div>
            </div>
            <div class="row">
...
<!--                            <img class="img-fluid rounded" src="/gestpymes/css/img/sancion.jpg" alt="">-->
                        ...
                        <div class="card-body">
                            ...
                            <h2 class="card-title title"><form action="<?php echo $helper->url('Empresa','cargarEmpleadosSanciones'); ?>" method="POST">
